...
![screenshot](screenshots/git01.png)

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![screenshot](screenshots/git02.png)
...
![screenshot](screenshots/git03.png)
...
![screenshot](screenshots/git04.png)
...
![screenshot](screenshots/git05.png)

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![screenshot](screenshots/git06.png)
...
![screenshot](screenshots/git07.png)

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![screenshot](screenshots/git08.png)
...
![screenshot](screenshots/git09.png)

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![screenshot](screenshots/git10.png)

---

#### Screenshot 11 — Output of `git commit`

![screenshot](screenshots/git11.png)

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![screenshot](screenshots/git12.png)
...
https://www.linkedin.com/posts/wale-folarin-956b6022a_devops-git-linux-share-7485085921034448897-n8Bi/?utm_source=share&utm_medium=member_desktop&rcm=ACoAADl6z1IBZjWVdPX--51VXY7TxU7dXOVzE3c
